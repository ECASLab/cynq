...
class AXIGPIO : public MMIOAccelerator {
 public:
  ...
  /**
   * @brief Reads a GPIO channel
   *
   * It reads a single channel of the GPIO
   *
   * @param channel GPIO channel
   *
   * @param start_bit GPIO start pin
   *
   ...
   *
   * It writes a single channel of the GPIO
   *
   * @param channel GPIO channel
   *
   * @param start_bit GPIO start pin
   ...
   * @return Status
   */
  Status Config(const uint channel, const uint start_bit, const uint stop_bit,
